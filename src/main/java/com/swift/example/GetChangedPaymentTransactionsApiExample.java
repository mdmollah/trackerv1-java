...
public class GetChangedPaymentTransactionsApiExample {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
        ...
        String xRecord = UtilHelper.getInstance().mymap.get("GetChangedPaymentTransactionsApiTest.xRecord"); // String | A type of API response to get from API Sandbox. A value between 1 and 13
        try {
